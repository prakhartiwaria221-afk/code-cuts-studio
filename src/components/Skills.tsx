    ...
    <section id="skills" className="py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-6xl mb-16">
          {/* Tech Skills */}
          <div className="p-6 sm:p-8 rounded-3xl card-parchment magic-border transition-all duration-300">
        ...
        <div className="flex flex-wrap gap-3 max-w-3xl">
          {tools.map((tool, index) => (
            <div
              key={index}
              className="flex items-center gap-2 px-5 py-2.5 rounded-full card-parchment magic-border transition-all duration-300 text-sm"
            >
